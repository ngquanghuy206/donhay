...
const OS_LIST = [
  ...
  },
  {
    ...
    vendor: "Google / OEM",
    mono: "AND",
    icon: `<svg viewBox="0 0 576 512" fill="currentColor"><path d="M420.55,301.93a24,24,0,1,1,24-24,24,24,0,0,1-24,24m-265.1,0a24,24,0,1,1,24-24,24,24,0,0,1-24,24m273.7-144.48,47.94-83a10,10,0,1,0-17.27-10h0l-48.54,84.07a301.25,301.25,0,0,0-246.56,0L116.18,64.45a10,10,0,1,0-17.27,10h0l47.94,83C64.53,202.22,8.24,285.55,0,384H576c-8.24-98.45-64.54-181.78-146.85-226.55"/></svg>`
  },
  {
    id: "harmony",
    name: "HarmonyOS",
    vendor: "Huawei",
    mono: "HM",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><circle cx="12" cy="12" r="2.4" fill="currentColor" stroke="none"/><ellipse cx="12" cy="12" rx="10" ry="4.2"/><ellipse cx="12" cy="12" rx="10" ry="4.2" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.2" transform="rotate(120 12 12)"/></svg>`
  }
];
...
d("rd14c", "Redmi 14C", "Redmi", "android", 6.88, 269, 90, 4, 1, 2024);
d("rd14", "Redmi 14", "Redmi", "android", 6.67, 395, 120, 8, 2, 2024);
d("rd13", "Redmi 13", "Redmi", "android", 6.79, 264, 90, 6, 1, 2024);
d("rd10c", "Redmi 10C", "Redmi", "android", 6.71, 269, 60, 4, 1, 2022);
d("rd10a", "Redmi 10A", "Redmi", "android", 6.53, 269, 60, 3, 1, 2022);
d("rd9a", "Redmi 9A", "Redmi", "android", 6.53, 269, 60, 3, 1, 2020);
d("rd9c", "Redmi 9C", "Redmi", "android", 6.53, 269, 60, 3, 1, 2020);
d("rd9", "Redmi 9", "Redmi", "android", 6.53, 281, 60, 4, 1, 2020);
d("rdnote14", "Redmi Note 14", "Redmi", "android", 6.67, 395, 120, 8, 2, 2024);
d("rdnote14pro", "Redmi Note 14 Pro", "Redmi", "android", 6.67, 395, 120, 8, 3, 2024);
d("rdnote14proplus", "Redmi Note 14 Pro+", "Redmi", "android", 6.67, 395, 120, 12, 4, 2024);
d("rdnote13proplus", "Redmi Note 13 Pro+", "Redmi", "android", 6.67, 395, 120, 12, 4, 2023);
d("rdnote12s", "Redmi Note 12S", "Redmi", "android", 6.43, 409, 90, 6, 2, 2023);
d("rdnote12proplus", "Redmi Note 12 Pro+", "Redmi", "android", 6.67, 395, 200, 8, 3, 2022);
d("rdnote11s", "Redmi Note 11S", "Redmi", "android", 6.43, 409, 90, 6, 2, 2022);
d("rdnote11pro", "Redmi Note 11 Pro", "Redmi", "android", 6.67, 395, 120, 6, 3, 2022);
d("rdnote10pro", "Redmi Note 10 Pro", "Redmi", "android", 6.67, 395, 120, 6, 3, 2021);
d("rdnote10s", "Redmi Note 10S", "Redmi", "android", 6.43, 409, 60, 6, 2, 2021);
d("rdnote9pro", "Redmi Note 9 Pro", "Redmi", "android", 6.67, 395, 60, 6, 2, 2020);
d("rdnote9s", "Redmi Note 9S", "Redmi", "android", 6.67, 395, 60, 6, 2, 2020);
d("rdnote8", "Redmi Note 8", "Redmi", "android", 6.3, 409, 60, 4, 1, 2019);
d("rdnote8pro", "Redmi Note 8 Pro", "Redmi", "android", 6.53, 395, 60, 6, 2, 2019);
d("rdturbo4", "Redmi Turbo 4", "Redmi", "android", 6.67, 395, 144, 12, 4, 2025);
d("rdturbo3", "Redmi Turbo 3", "Redmi", "android", 6.67, 395, 144, 8, 4, 2024);
d("rdk70", "Redmi K70", "Redmi", "android", 6.67, 395, 144, 12, 4, 2023);
d("rdk70pro", "Redmi K70 Pro", "Redmi", "android", 6.67, 446, 144, 16, 5, 2023);
d("rdk80", "Redmi K80", "Redmi", "android", 6.67, 395, 144, 12, 4, 2024);
d("rdk80pro", "Redmi K80 Pro", "Redmi", "android", 6.67, 446, 144, 16, 5, 2024);
...
// Cập nhật dòng máy mới nhất 2025-2026
d("ip17", "iPhone 17", "Apple", "ios", 6.3, 460, 120, 8, 4, 2025);
d("ip17air", "iPhone Air", "Apple", "ios", 6.5, 460, 120, 12, 5, 2025);
d("ip17pro", "iPhone 17 Pro", "Apple", "ios", 6.3, 460, 120, 12, 5, 2025);
d("ip17pm", "iPhone 17 Pro Max", "Apple", "ios", 6.9, 460, 120, 12, 5, 2025);

d("s25", "Samsung Galaxy S25", "Samsung", "android", 6.2, 416, 120, 12, 4, 2025);
d("s25p", "Samsung Galaxy S25+", "Samsung", "android", 6.7, 513, 120, 12, 4, 2025);
d("s25edge", "Samsung Galaxy S25 Edge", "Samsung", "android", 6.7, 513, 120, 12, 4, 2025);
d("s25u", "Samsung Galaxy S25 Ultra", "Samsung", "android", 6.9, 498, 120, 12, 5, 2025);

d("s26", "Samsung Galaxy S26", "Samsung", "android", 6.3, 422, 120, 12, 4, 2026);
d("s26p", "Samsung Galaxy S26+", "Samsung", "android", 6.7, 513, 120, 12, 5, 2026);
d("s26u", "Samsung Galaxy S26 Ultra", "Samsung", "android", 6.9, 505, 120, 12, 5, 2026);

d("pixel10", "Google Pixel 10", "Google", "android", 6.3, 422, 120, 12, 4, 2025);
d("pixel10pro", "Google Pixel 10 Pro", "Google", "android", 6.3, 495, 120, 16, 5, 2025);
d("pixel10prox", "Google Pixel 10 Pro XL", "Google", "android", 6.8, 486, 120, 16, 5, 2025);
